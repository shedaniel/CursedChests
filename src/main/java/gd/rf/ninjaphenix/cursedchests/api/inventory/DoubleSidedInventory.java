package gd.rf.ninjaphenix.cursedchests.api.inventory;
...
public class DoubleSidedInventory implements SidedInventory
{
	...
	@Override public int[] getInvAvailableSlots(Direction direction)
	{
	...
	@Override public boolean canExtractInvStack(int slot, ItemStack stack, Direction direction)
	{
