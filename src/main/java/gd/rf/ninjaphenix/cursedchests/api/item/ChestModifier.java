...
public interface ChestModifier
{
     ...
     * Implementations of this method should: - check if the modifier can be applied - apply the modifier - modify the player's inventory e.g. remove the
     * modifier item(s) - return if the modifier was applied or not.
     *
     ...
     * @since 1.0.5
     */
    default ActionResult useOnChest(World world, PlayerEntity player, Hand hand, BlockHitResult blockHitResult, BlockPos mainBlockPos, BlockPos topBlockPos)
