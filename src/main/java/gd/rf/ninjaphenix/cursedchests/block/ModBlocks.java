...
public class ModBlocks
{
	...
	{
		wood_chest = register(new CursedChestBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).build()), "wood_chest", 3, new Identifier("minecraft", "textures/entity/chest/normal.png"), new Identifier("cursedchests", "textures/entity/wood_chest/double.png"), new TranslatableComponent("container.cursedchests.wood_chest"));
		iron_chest = register(new CursedChestBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).build()), "iron_chest", 6, new Identifier("cursedchests", "textures/entity/iron_chest/single.png"), new Identifier("cursedchests", "textures/entity/iron_chest/double.png"), new TranslatableComponent("container.cursedchests.iron_chest"));
		gold_chest = register(new CursedChestBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).build()), "gold_chest", 9, new Identifier("cursedchests", "textures/entity/gold_chest/single.png"), new Identifier("cursedchests", "textures/entity/gold_chest/double.png"), new TranslatableComponent("container.cursedchests.gold_chest"));
	...
	private static CursedChestBlock register(CursedChestBlock block, String name, int rows, Identifier singleTexture, Identifier doubleTexture, TranslatableComponent containerName)
	{
