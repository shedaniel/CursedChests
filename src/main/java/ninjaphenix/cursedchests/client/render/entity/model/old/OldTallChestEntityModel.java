...
public class OldTallChestEntityModel extends ChestEntityModel
{
    public OldTallChestEntityModel()
    {
        lid = null;
        hatch = null;
        base = new Cuboid(this, 0, 0).setTextureSize(64, 48);
        base.addBox(0, -16, 0, 16, 32, 16, 0);
    }
