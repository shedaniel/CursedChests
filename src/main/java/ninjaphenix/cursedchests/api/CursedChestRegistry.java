...
public class CursedChestRegistry
{
    ...
    /**
     * Gets a new instance of a registered chest block's block entity. Used in {@link ninjaphenix.cursedchests.mixins.ItemDynamicRenderer} to render the chests
     * properly in inventories.
     *
     * @param block The identifier for the vertical chest block.
